...
ckpt = dict(
    ...
    async_upload_tmp_folder="/home/hostpath/pth/InternLM/tmp",  # path for temporarily files during asynchronous upload.
    oss_snapshot_freq=int(CHECKPOINT_EVERY / 2),  # snapshot ckpt save frequency.
)

TRAIN_FOLDER = "/home/hostpath/alpaca.bin/train"  # "/path/to/dataset"
VALID_FOLDER = "/home/hostpath/alpaca.bin/valid"  # "/path/to/dataset"
data = dict(
    seq_len=SEQ_LEN,
